...
We also only have listings that are based in North America,
so if you feel like you need to look elsewhere, use the right tool.
If user doesn't specify the country, just assume it's North America.
`;

export default ROUTER_PROMPT;
